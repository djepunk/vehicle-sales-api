...
use App\Repositories\PenjualanPerKendaraanRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(PenjualanPerKendaraanRepositoryInterface::class, PenjualanPerKendaraanRepository::class);
    }
